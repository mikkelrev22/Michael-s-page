  ...
  return (
    <div>
      ...
      <div className="body-text">
        I was born and raised in Seattle, Washington. I love learning about new things and being creative. Programming has become one of my passions. In addition, I love learning about the world, playing sports, and enjoying the outdoors.
      </div>
